...
var createSocket = function createSocket(user_id) {
  var channel = socket.channel("user:" + user_id, {});
...
function renderTweets(tweets) {
  var renderedTweets = tweets.map(function (tweet) {
...
function renderTweet(event) {
  var renderedTweet = tweetTemplate(event.tweet);
